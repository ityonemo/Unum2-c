...
void PTile4_synthtests(){
  ...
  assert(tile_epoch(pf1001) == 0);
  assert(tile_epoch(pf1010) == 0);
  assert(tile_epoch(pf1011) == 0);
  assert(tile_epoch(pf1100) == 0);
  assert(tile_epoch(pf1101) == 0);
  assert(tile_epoch(pf1110) == 0);
  assert(tile_epoch(pf1111) == 0);
  assert(tile_epoch(pf0001) == 0);
  assert(tile_epoch(pf0010) == 0);
  assert(tile_epoch(pf0011) == 0);
  assert(tile_epoch(pf0100) == 0);
  assert(tile_epoch(pf0101) == 0);
  assert(tile_epoch(pf0110) == 0);
  assert(tile_epoch(pf0111) == 0);

  assert(tile_lattice(pf1001) == 0x0000000000000003);
  assert(tile_lattice(pf1010) == 0x0000000000000002);
  assert(tile_lattice(pf1011) == 0x0000000000000001);
  assert(tile_lattice(pf1100) == 0x0000000000000000);
  assert(tile_lattice(pf1101) == 0x0000000000000001);
  assert(tile_lattice(pf1110) == 0x0000000000000002);
  assert(tile_lattice(pf1111) == 0x0000000000000003);
  assert(tile_lattice(pf0001) == 0x0000000000000003);
  assert(tile_lattice(pf0010) == 0x0000000000000002);
  assert(tile_lattice(pf0011) == 0x0000000000000001);
  assert(tile_lattice(pf0100) == 0x0000000000000000);
  assert(tile_lattice(pf0101) == 0x0000000000000001);
  assert(tile_lattice(pf0110) == 0x0000000000000002);
  assert(tile_lattice(pf0111) == 0x0000000000000003);
}
